...
@Injectable()
@WorkspaceQueryHook(`newLead.updateMany`)
export class NewLeadUpdateManyPreQueryHook
  implements WorkspacePreQueryHookInstance
{
  ...
  async execute(
    ...
    payload: UpdateManyResolverArgs<Record<string, any>>,
    // eslint-disable-next-line @typescript-eslint/no-explicit-any
  ): Promise<UpdateManyResolverArgs<Record<string, any>>> {
