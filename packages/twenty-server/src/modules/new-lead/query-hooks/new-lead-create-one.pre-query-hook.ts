...
@Injectable()
@WorkspaceQueryHook(`newLead.createOne`)
export class NewLeadCreateOnePreQueryHook
  implements WorkspacePreQueryHookInstance
{
  ...
  async execute(
    ...
    // Always override teamId and managerId with current user's team info
    // This ensures the fields are system-managed and always up-to-date
